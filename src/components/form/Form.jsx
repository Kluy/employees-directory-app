        ...
        <fieldset className="fieldset">
          ...
          {positionsList.map(elem => (
            <div className="radio-wrapper" key={elem}>
              <Input type="radio" className="input__radio" id={elem} name="position" value={elem} />
              <label htmlFor={elem}>{elem}</label>
            </div>
          ))}
        </fieldset>
        <Input className="input input_file" type="file" id="upload" />
        <label className="input input_file__label" htmlFor="upload">
          Upload your photo
        </label>
        <Button className="button" type="submit" text="Sign up" disabled={true} />
      </form>
    </section>
  );
};
